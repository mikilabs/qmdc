...
class Storage:
    """SQLite storage for QMD Semantic.
    ...
    def __init__(self, workspace_path: Path | str):
        ...
        Args:
            workspace_path: Path to workspace directory.
                Database is created at .qmd-semantic/embeddings.db
        """
        self.workspace_path = Path(workspace_path)
        self.db_dir = self.workspace_path / ".qmd-semantic"
    ...
    def _create_schema(self):
        ...
        # Explicit edges table (from [[#ref]] in QMD files)
        cursor.execute("""
    ...
    def _normalize_fts_query(self, query: str) -> str:
        ...
        - Converts "QMD-17" to "qmd17 OR QMD 17" for better matching
