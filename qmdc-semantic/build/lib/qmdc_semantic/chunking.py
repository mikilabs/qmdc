"""Chunking algorithm for QMD objects.
...
def compute_global_id(obj: dict[str, Any]) -> str:
    ...
    Args:
        obj: QMD object with __workspace, __namespace, __id fields.
...
def enrich_objects_with_global_id(objects: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    Args:
        objects: List of QMD objects from parse_workspace.
...
def _extract_id_variants(global_id: str, obj_id: str) -> str:
    ...
    For "qmd41" returns "qmd41 QMD-41 QMD 41" for FTS matching.
    """
    import re
...
def extract_object_chunks(
    ...
    """Extract chunks from a single QMD object.
    ...
    Args:
        obj: QMD object dict with __id, __kind, __label, __file, etc.
...
def extract_chunks(
    ...
    """Extract all chunks from a QMD workspace.
